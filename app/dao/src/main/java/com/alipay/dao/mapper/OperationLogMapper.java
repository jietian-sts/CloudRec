...
public interface OperationLogMapper {
    ...
    OperationLogPO selectByPrimaryKey(Long id);

    int updateByPrimaryKeySelective(OperationLogPO record);

    int updateByPrimaryKeyWithBLOBs(OperationLogPO record);

    int updateByPrimaryKey(OperationLogPO record);

    int findCount(OperationLogDTO operationLogDTO);

    List<OperationLogPO> findList(OperationLogDTO operationLogDTO);
}