...
import com.alipay.dao.po.AgentRegistryCloudAccountPO;
import org.apache.ibatis.annotations.Param;

import java.util.List;

public interface AgentRegistryCloudAccountMapper {
    int deleteByPrimaryKey(Long id);

    int insertSelective(AgentRegistryCloudAccountPO record);

    AgentRegistryCloudAccountPO selectByPrimaryKey(Long id);
